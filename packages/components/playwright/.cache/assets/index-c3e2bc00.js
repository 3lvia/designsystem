...
document.addEventListener('DOMContentLoaded', function () {
  let e = {
      ...
      'e-icon--car_charger-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="m11.01 0 11.672.31a1.131 1.131 0 0 1 1.103 1.114L24 16.992l-2.031 2.186a1.13 1.13 0 0 1-.79.322H8.006a1 1 0 0 1-1-1.007l.06-8.48c.458-.206.91-.415 1.262-.598l-.058 8.429 2.133-1.5V1.32l-2.02.199-.03 4.246c-.33.073-.768.174-1.26.298l.032-4.666A1.13 1.13 0 0 1 8.148.282L11.01 0Zm.653 1.273v14.832h11.066l-.201-14.543-10.865-.29ZM22.25 17.36H11.18l-1.18.885h11.277l.973-.885Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M8.684 8.027v-1.75c-.997.226-2.324.556-3.568.955-.861.277-1.639.572-2.226.872-.294.15-.509.284-.653.397a.97.97 0 0 0-.142.13c-.119.252-.246.68-.359 1.284-.112.6-.197 1.296-.259 2.018a46.971 46.971 0 0 0-.15 2.97h.815l1.21-3.533c.04-.113.182-.523.607-.807.232-.155.73-.411 1.216-.66l.45-.23c.423-.216.884-.451 1.337-.688a30.782 30.782 0 0 0 1.722-.958ZM10 8.614V5.29a.514.514 0 0 0-.618-.51C7.46 5.18 1.674 6.5.924 8.032.12 9.671.014 13.941 0 15.694a.52.52 0 0 0 .524.523h.627c-.18 1.166-.238 2.93.186 4.477.427 1.56 1.416 3.096 3.463 3.303.357.036.677-.211.715-.552a.628.628 0 0 0-.578-.682c-1.25-.126-1.972-1.029-2.342-2.382-.37-1.349-.32-2.952-.153-4.016.008-.05.009-.1.005-.148h.26a.525.525 0 0 0 .498-.355l1.393-4.067a.259.259 0 0 1 .092-.14c.192-.127.795-.435 1.528-.81C7.803 10.038 10 8.916 10 8.616Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="m14.49 8.203-.412.614a.9.9 0 0 0-.141.915.789.789 0 0 0 .583.428l1.202.19a.096.096 0 0 1 .085.111l-.618 4.224a.272.272 0 0 0 .166.297.277.277 0 0 0 .322-.096L18.56 11l1.391-1.801a.975.975 0 0 0 .16-.387.879.879 0 0 0 0-.413.805.805 0 0 0-.21-.357.643.643 0 0 0-.367-.186l-1.222-.196a.08.08 0 0 1-.07-.09c.09-.553.643-4.073.638-4.325-.005-.251-.392-.347-.568-.105L15.81 6.5l-1.32 1.703Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--chainsaw':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.666.587a.751.751 0 0 0-1.467.329l.42 1.878A4.51 4.51 0 0 0 2.8 4.59L.958 4.064A.751.751 0 1 0 .546 5.51l1.756.5a4.507 4.507 0 0 0 .742 3.332l-1.017.936a.751.751 0 1 0 1.018 1.106l1.023-.94 2.358 2.255-1.172 1.079a.751.751 0 1 0 1.019 1.105l1.242-1.143 1.901 1.819-.5.46c-1.359 1.252-1.419 3.335-.13 4.523l3.08 2.686c1.362 1.255 3.594.938 4.696-.667l.478-.697 4.834.176a.75.75 0 0 0 .739-.411l1.306-2.543a.75.75 0 0 0-.335-1.007l-2.886-1.544 1.331-1.94c.77-1
z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--charge':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 5.72a.75.75 0 0 1 .75.75v10.78a.75.75 0 0 0 .75.75h7.52a.75.75 0 0 1 0 1.5H5.25A2.25 2.25 0 0 1 3 17.25V6.47a.75.75 0 0 1 .75-.75Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M10.036.177a.75.75 0 0 1 .968 0l8.88 7.5a.75.75 0 1 1-.968 1.146L10.52 1.732 1.234 9.573a.75.75 0 0 1-.968-1.146l9.77-8.25ZM17.25 12a.75.75 0 0 0-.75.75v9c0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75v-9a.75.75 0 0 0-.75-.75h-4.5Zm-2.25.75a2.25 2.25 0 0 1 2.25-2.25h4.5A2.25 2.25 0 0 1 24 12.75v9A2.25 2.25 0 0 1 21.75 24h-4.5A2.25 2.25 0 0 1 15 21.75v-9Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M15 20.25a.75.75 0 0 1 .75-.75h7.5a.75.75 0 0 1 0 1.5h-7.5a.75.75 0 0 1-.75-.75ZM10.52 6.75a.75.75 0 0 1 .75.75V10a.75.75 0 0 1-1.5 0V7.5a.75.75 0 0 1 .75-.75Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M8.93 8.33a.75.75 0 0 1 0 1.06 2.25 2.25 0 1 0 3.18 0 .75.75 0 1 1 1.06-1.06 3.75 3.75 0 1 1-5.3 0 .75.75 0 0 1 1.06 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--charging_battery-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M.938 6.537c.6-.6 1.414-.937 2.263-.937H17.6a3.2 3.2 0 0 1 3.2 3.2h.8a2.4 2.4 0 0 1 2.4 2.4v1.6a2.4 2.4 0 0 1-2.4 2.4h-.8a3.2 3.2 0 0 1-3.2 3.2H3.2A3.2 3.2 0 0 1 0 15.2V8.8c0-.849.338-1.663.938-2.263Zm2.263.663A1.601 1.601 0 0 0 1.6 8.8v6.4a1.6 1.6 0 0 0 1.6 1.6h14.4a1.6 1.6 0 0 0 1.6-1.6v-.8a.8.8 0 0 1 .8-.8h1.6a.8.8 0 0 0 .8-.8v-1.6a.8.8 0 0 0-.8-.8H20a.8.8 0 0 1-.8-.8v-.8a1.6 1.6 0 0 0-1.6-1.6H3.201Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M5.601 8.8a.8.8 0 0 1 .8.8v4.8a.8.8 0 1 1-1.6 0V9.6a.8.8 0 0 1 .8-.8ZM10.401 8.8a.8.8 0 0 1 .8.8v4.8a.8.8 0 1 1-1.6 0V9.6a.8.8 0 0 1 .8-.8Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--check':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M23.468.225c.562.393.699 1.168.305 1.73L9.346 22.566l-.001.002a3.347 3.347 0 0 1-5.427.09v-.002l-3.67-4.89a1.243 1.243 0 0 1 1.99-1.492l3.672 4.895a.86.86 0 0 0 1.395-.023l.002-.003L21.737.53a1.243 1.243 0 0 1 1.73-.305Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--check-bold':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M23.468.225c.562.393.699 1.168.305 1.73L9.346 22.566l-.001.002a3.347 3.347 0 0 1-5.427.09v-.002l-3.67-4.89a1.243 1.243 0 0 1 1.99-1.492l3.672 4.895a.86.86 0 0 0 1.395-.023l.002-.003L21.737.53a1.243 1.243 0 0 1 1.73-.305Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--check_circle':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.591 11.31a.75.75 0 0 0-1.06 1.06l3.535 3.53a.75.75 0 0 0 1.06 0l7.072-7.062a.749.749 0 1 0-1.061-1.06l-6.54 6.534L7.59 11.31Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M0 12c0 6.617 5.383 12 12 12s12-5.383 12-12S18.617 0 12 0 0 5.383 0 12Zm1.5 0C1.5 6.21 6.21 1.5 12 1.5S22.5 6.21 22.5 12 17.79 22.5 12 22.5 1.5 17.79 1.5 12Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--check_circle-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 24C5.383 24 0 18.617 0 12S5.383 0 12 0s12 5.383 12 12-5.383 12-12 12Zm0-22.5C6.21 1.5 1.5 6.21 1.5 12S6.21 22.5 12 22.5 22.5 17.79 22.5 12 17.79 1.5 12 1.5Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M6.53 11.31a.75.75 0 0 1 1.061 0l3.005 3.002 6.54-6.534a.75.75 0 0 1 1.062 1.06L11.126 15.9a.75.75 0 0 1-1.06 0L6.53 12.369a.749.749 0 0 1 0-1.06Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--check_circle-filled':
      ...
      'e-icon--pie_chart':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.5 10.5a.75.75 0 0 1-.75-.75v-9A.75.75 0 0 1 13.5 0c5.376 0 9.75 4.374 9.75 9.75a.75.75 0 0 1-.75.75h-9ZM21.716 9c-.359-3.929-3.537-7.107-7.466-7.466V9h7.466Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path d="M10.501 24a9.688 9.688 0 0 1-6.894-2.855 9.683 9.683 0 0 1-2.856-6.894 9.687 9.687 0 0 1 2.855-6.894A9.684 9.684 0 0 1 10.5 4.5a.753.753 0 0 1 .75.75v8.741l5.401 6.873a.743.743 0 0 1 .155.553.745.745 0 0 1-.281.5A9.795 9.795 0 0 1 10.501 24ZM9.75 6.034a8.216 8.216 0 0 0-5.083 2.383 8.196 8.196 0 0 0-2.416 5.834 8.19 8.19 0 0 0 2.417 5.833 8.196 8.196 0 0 0 5.833 2.416c1.58 0 3.157-.469 4.486-1.327l-5.076-6.46a.756.756 0 0 1-.16-.463V6.034H9.75Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path d="M19.061 20.577a.743.743 0 0 1-.59-.287l-5.561-7.077a.753.753 0 0 1-.084-.792A.755.755 0 0 1 13.5 12h9a.75.75 0 0 1 .75.749 9.677 9.677 0 0 1-3.726 7.667.746.746 0 0 1-.463.161Zm.106-1.829a8.116 8.116 0 0 0 2.551-5.248h-6.674l4.123 5.248Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--piggy_bank-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.087 10.5c-.2 0-.4-.08-.54-.23l-4.38-4.57c-.49-.49-.81-1.12-.92-1.82-.11-.7 0-1.4.31-2.03.24-.48.59-.89 1.01-1.2.42-.31.92-.52 1.45-.61.52-.08 1.06-.04 1.56.12s.96.45 1.34.82l.18.19.19-.19c.37-.37.83-.66 1.34-.82.5-.16 1.04-.2 1.56-.12.52.08 1.02.29 1.45.61.42.31.77.73 1.01 1
z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--pin-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 1.5a6.75 6.75 0 0 0-6.75 6.75c0 .706.273 1.77.772 3.08.49 1.287 1.167 2.732 1.907 4.169 1.48 2.874 3.184 5.665 4.071 7.001l-.625.415L12 22.5l.625.415L12 22.5c.887-1.336 2.591-4.127 4.071-7.001.74-1.438 1.417-2.883 1.907-4.17.499-1.308.772-2.373.772-3.079A6.75 6.75 0 0 0 12 1.5ZM12 0a8.25 8.25 0 0 0-8.25 8.25c0 .997.361 2.278.87 3.614.518 1.358 1.222 2.857 1.975 4.321 1.508 2.928 3.24 5.766 4.155 7.145a1.5 1.5 0 0 0 2.5 0c.914-1.379 2.647-4.217 4.155-7.145.753-1.463 1.457-2.963 1.975-4.321.509-1.336.87-2.617.87-3.614A8.25 8.25 0 0 0 12 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 5.25a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-4.5 3a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--pin-filled':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 0a8.25 8.25 0 0 0-8.25 8.25c0 .997.361 2.278.87 3.614.518 1.358 1.222 2.857 1.975 4.321 1.508 2.928 3.24 5.766 4.155 7.145a1.5 1.5 0 0 0 2.5 0c.914-1.379 2.647-4.217 4.155-7.145.753-1.463 1.457-2.963 1.975-4.321.509-1.336.87-2.617.87-3.614A8.25 8.25 0 0 0 12 0Z" fill="var(--e-color-icon-filled-background-1, var(--e-color-icon-filled-background-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 5.25a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-4.5 3a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0Z" fill="var(--e-color-icon-filled-foreground-1, var(--e-color-icon-filled-foreground-1, #FFFFFF))"/></svg>',
      'e-icon--pin-filled-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#a)" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 3.75a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9Zm-3 4.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0Z" fill="#000"/><path d="M6.166 2.416A8.25 8.25 0 0 1 20.25 8.25c0 .997-.361 2.278-.87 3.614-.518 1.358-1.222 2.857-1.975 4.321-1.508 2.928-3.24 5.766-4.155 7.145a1.5 1.5 0 0 1-2.5 0c-.914-1.379-2.647-4.217-4.155-7.145-.753-1.463-1.457-2.963-1.975-4.321-.509-1.336-.87-2.617-.87-3.614a8.25 8.25 0 0 1 2.416-5.834Zm1.061 1.061A6.75 6.75 0 0 1 18.75 8.25c0 .706-.273 1.77-.772 3.08-.49 1.287-1.167 2.732-1.907 4.169-1.48 2.874-3.184 5.665-4.071 7.001-.887-1.336-2.591-4.127-4.071-7.001-.74-1.438-1.417-2.883-1.907-4.17-.499-1.308-.772-2.373-.772-3.079a6.75 6.75 0 0 1 1.977-4.773Z" fill="#000"/><path d="M12 1.5a6.75 6.75 0 0 0-6.75 6.75c0 .706.273 1.77.772 3.08.49 1.287 1.167 2.732 1.907 4.169 1.48 2.874 3.184 5.665 4.071 7.001.887-1.336 2.591-4.127 4.071-7.001.74-1.438 1.417-2.883 1.907-4.17.499-1.308.772-2.373.772-3.079A6.75 6.75 0 0 0 12 1.5Zm0 2.25a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs></svg>',
      'e-icon--play_circle-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.906 7.36a1.069 1.069 0 0 1 1.15.015l7.181 3.592c.318.16.645.455.645.894 0 .44-.326.735-.645.894l-7.182 3.591a1.069 1.069 0 0 1-1.647-1.019V8.396a1.07 1.07 0 0 1 .498-1.036Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 1.756C6.342 1.756 1.756 6.342 1.756 12c0 5.658 4.586 10.244 10.244 10.244 5.658 0 10.244-4.586 10.244-10.244 0-5.658-4.586-10.244-10.244-10.244ZM0 12C0 5.373 5.373 0 12 0s12 5.373 12 12-5.373 12-12 12S0 18.627 0 12Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--play_circle-filled-color':
      ...
      'e-icon--plus':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.243 1.243a1.243 1.243 0 1 0-2.486 0v9.514H1.243a1.243 1.243 0 1 0 0 2.486h9.514v9.514a1.243 1.243 0 1 0 2.486 0v-9.514h9.514a1.243 1.243 0 1 0 0-2.486h-9.514V1.243Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--plus-bold':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M13.243 1.243a1.243 1.243 0 1 0-2.486 0v9.514H1.243a1.243 1.243 0 1 0 0 2.486h9.514v9.514a1.243 1.243 0 1 0 2.486 0v-9.514h9.514a1.243 1.243 0 1 0 0-2.486h-9.514V1.243Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--position-bold':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 12a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M10.88 1a1 1 0 0 1 1-1h.25a1 1 0 0 1 1 1v1.466a9.604 9.604 0 0 1 8.405 8.409H23a1 1 0 0 1 1 1v.25a1 1 0 0 1-1 1h-1.465a9.604 9.604 0 0 1-8.405 8.41V23a1 1 0 0 1-1 1h-.25a1 1 0 0 1-1-1v-1.465a9.604 9.604 0 0 1-8.415-8.41H1a1 1 0 0 1-1-1v-.25a1 1 0 0 1 1-1h1.465a9.604 9.604 0 0 1 8.415-8.41V1ZM12 19.35a7.35 7.35 0 1 0 0-14.7 7.35 7.35 0 0 0 0 14.7Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--position-bold-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 12a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M10.88 1a1 1 0 0 1 1-1h.25a1 1 0 0 1 1 1v1.466a9.604 9.604 0 0 1 8.405 8.409H23a1 1 0 0 1 1 1v.25a1 1 0 0 1-1 1h-1.465a9.604 9.604 0 0 1-8.405 8.41V23a1 1 0 0 1-1 1h-.25a1 1 0 0 1-1-1v-1.465a9.604 9.604 0 0 1-8.415-8.41H1a1 1 0 0 1-1-1v-.25a1 1 0 0 1 1-1h1.465a9.604 9.604 0 0 1 8.415-8.41V1ZM12 19.35a7.35 7.35 0 1 0 0-14.7 7.35 7.35 0 0 0 0 14.7Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon
z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--power_outage-orange-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m21.717 23.254-19.434-.02a2.238 2.238 0 0 1-2-3.33l9.748-17.98a2.24 2.24 0 0 1 3.938 0l9.748 18a2.241 2.241 0 0 1-2 3.33ZM12.03 2.234a.77.77 0 0 0-.66.39l-9.737 18a.75.75 0 0 0 0 .74.77.77 0 0 0 .65.37h19.494a.77.77 0 0 0 .65-.37.78.78 0 0 0 0-.74l-9.747-18a.77.77 0 0 0-.65-.39Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path d="m15.558 16.525-7.043-5.634a.566.566 0 0 0-.838.09.532.532 0 0 0 .108.787l1.256 1.007a.057.057 0 0 1 0 .079l-.464.69a1.013 1.013 0 0 0-.159 1.03.89.89 0 0 0 .657.48l1.352.215a.108.108 0 0 1 .094.081c.004.014.004.03.002.044l-.696 4.752a.305.305 0 0 0 .187.334.311.311 0 0 0 .362-.108l3.004-4.04a.062.062 0 0 1 .084 0l1.364 1.036a.513.513 0 0 0 .764-.068.52.52 0 0 0-.034-.775ZM13.98 7.276c.005.283-.617 4.243-.72 4.865a.092.092 0 0 0 .02.067.091.091 0 0 0 .06.035l1.375.22a.724.724 0 0 1 .413.21c.113.11.194.249.237.401a.991.991 0 0 1 0 .464c-.028.157-.09.305-.18.436l-.408.566a.137.137 0 0 1-.153.031.137.137 0 0 1-.045-.031l-2.133-1.726-2.036-1.63a.09.09 0 0 1 0-.124l2.93-3.903c.198-.272.634-.164.64.119Z" fill="var(--e-color-icon-warning, var(--e-color-icon-warning, #FFA000))"/></svg>',
      'e-icon--power_service':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.2 10.5c-3.7 0-6.6 2.7-6.8 6.3H6.3c-3.3 0-4.8-3.1-4.8-6 0-1.7.5-3.3 1.3-4.4.9-1.3 2.3-1.9 3.9-1.9h1.5c.3 1.7 1.9 3 3.7 3h1.5c1 0 1.8-.6 2.1-1.5H18c.4 0 .8-.3.8-.8s-.4-.7-.8-.7h-2.2V3H18c.4 0 .8-.3.8-.8s-.4-.7-.8-.7h-2.4C15.3.7 14.5 0 13.5 0H12c-1.8 0-3.3 1.3-3.7 3H6.8c-2.1 0-3.9.9-5.1 2.5C.6 7 0 8.8 0 10.9c0 3.7 2.2 7.5 6.3 7.5h4.2c.6 3.2 3.4 5.6 6.7 5.6 3.8 0 6.8-3.1 6.8-6.8 0-3.7-3-6.7-6.8-6.7ZM12 1.6h1.5c.4 0 .8.3.8.8v3c-.1.3-.4.6-.8.6H12c-1.2 0-2.2-1-2.2-2.2 0-1.2 1-2.2 2.2-2.2Zm5.2 20.8c-2.8 0-5.2-2.4-5.2-5.2 0-2.8 2.3-5.2 5.2-5.2 2.9 0 5.2 2.4 5.2 5.2 0 2.8-2.4 5.2-5.2 5.2Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M18.001 17.2c0 .5-.3.8-.8.8-.4 0-.8-.3-.8-.8v-3c0-.4.3-.8.8-.8s.8.3.8.8v3ZM16.1 19.9c0-.6.5-1.1 1.1-1.1.6 0 1.1.5 1.1 1.1 0 .6-.5 1.1-1.1 1.1-.6 0-1.1-.5-1.1-1.1Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--power_service-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.2 10.5c-3.7 0-6.6 2.7-6.8 6.3H6.3c-3.3 0-4.8-3.1-4.8-6 0-1.7.5-3.3 1.3-4.4.9-1.3 2.3-1.9 3.9-1.9h1.5c.3 1.7 1.9 3 3.7 3h1.5c1 0 1.8-.6 2.1-1.5H18c.4 0 .8-.3.8-.8s-.4-.7-.8-.7h-2.2V3H18c.4 0 .8-.3.8-.8s-.4-.7-.8-.7h-2.4C15.3.7 14.5 0 13.5 0H12c-1.8 0-3.3 1.3-3.7 3H6.8c-2.1 0-3.9.9-5.1 2.5C.6 7 0 8.8 0 10.9c0 3.7 2.2 7.5 6.3 7.5h4.2c.6 3.2 3.4 5.6 6.7 5.6 3.8 0 6.8-3.1 6.8-6.8 0-3.7-3-6.7-6.8-6.7ZM12 1.6h1.5c.4 0 .8.3.8.8v3c-.1.3-.4.6-.8.6H12c-1.2 0-2.2-1-2.2-2.2 0-1.2 1-2.2 2.2-2.2Zm5.2 20.8c-2.8 0-5.2-2.4-5.2-5.2 0-2.8 2.3-5.2 5.2-5.2 2.9 0 5.2 2.4 5.2 5.2 0 2.8-2.4 5.2-5.2 5.2Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M18.001 17.2c0 .5-.3.8-.8.8-.4 0-.8-.3-.8-.8v-3c0-.4.3-.8.8-.8s.8.3.8.8v3ZM16.1 19.9c0-.6.5-1.1 1.1-1.1.6 0 1.1.5 1.1 1.1 0 .6-.5 1.1-1.1 1.1-.6 0-1.1-.5-1.1-1.1Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--power-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="m6.98 10.407-.825 1.227a1.8 1.8 0 0 0-.281 1.83 1.579 1.579 0 0 0 1.166.855l2.404.382a.191.191 0 0 1 .17.221L8.379 23.37a.543.543 0 0 0 .332.594.553.553 0 0 0 .643-.191L15.12 16l2.782-3.602c.162-.232.272-.496.322-.774a1.758 1.758 0 0 0 0-.825 1.61 1.61 0 0 0-.423-.714 1.287 1.287 0 0 0-.734-.372l-2.444-.393a.16.16 0 0 1-.14-.18C14.662 8.032 15.77.992 15.76.49c-.01-.503-.785-.694-1.137-.211L9.62 7l-2.64 3.407Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--powerline':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.945 4.175H13.76l-5.22 3.91V21.96a.71.71 0 1 1-1.42 0V8.085L1.9 4.17H.715a.71.71 0 1 1 0-1.42h.71v-.71c0-.395.325-.71.715-.71.39 0 .71.315.71.71v.71h1.42v-.71c0-.395.33-.71.72-.71.39 0 .71.315.71.71v.71h4.27v-.71a.71.71 0 1 1 1.42 0v.71h1.425v-.71a.71.71 0 1 1 1.42 0v.71h.71c.395 0 .71.325.71.715a.71.71 0 0 1-.71.71ZM7.83 6.845l3.555-2.67H4.27l3.56 2.67Zm15.44 6.166a.714.714 0 0 1 .73.709.72.72 0 0 1-.74.715 15.53 15.53 0 0 1-12.19-5.86.714.714 0 0 1 .11-1 .714.714 0 0 1 1 .11 14.12 14.12 0 0 0 11.08 5.325l.01.001Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon
1.494-.795 0-1.492.697-1.492 1.494 0 .796.697 1.493 1.492 1.493.796 0 1.492-.697 1.492-1.493ZM13.656 4h-3.104v.918h2.172v1.02h-2.172v.92h2.172v1.224h-2.172V9h3.103V4ZM9.102 8.082H6.931V6.857h2.172V4H6v.918h2.172v1.02H6V9h3.103v-.918ZM18 5.939h-1.965v-1.02H18V4h-2.897v2.857h1.966v1.225h-1.966V9H18V5.939Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><rect x="15.13" y="17.78" width="2.19" height="2.19" rx="1.095" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/><rect x="15.13" y="14" width="2.19" height="2.19" rx="1.095" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/></svg>',
      'e-icon--powermeter_old':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 10.5c-.9 0-1.8.6-2.1 1.5H8.3c.4-1.7 1.9-3 3.7-3 .5 0 1 .1 1.5.2L16 5.5c.1-.2.3-.3.6-.3.1 0 .3 0 .4.1.1.1.3.3.3.5.1.2 0 .4-.1.6l-2.5 3.7c.5.5.9 1.2 1 1.9h-1.6c-.3-.9-1.2-1.5-2.1-1.5ZM16.2 17.2H7.8c-.4 0-.7-.3-.7-.7v-.1c0-.4.3-.7.7-.7h8.4c.4 0 .7.3.7.7v.1c0 .4-.3.7-.7.7Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M19.11 0H4.79C3.796 0 3 .797 3 1.793v20.415C3 23.203 3.796 24 4.79 24H19c.994 0 2-.797 2-1.793V1.793C20.9.797 20.105 0 19.11 0Zm.39 21.5c0 .1 0 1-1.048 1H5.5c-1 0-1-.9-1-1l-.008-8.156H19.5V21.5Zm0-9.5H4.492L4.5 4.297h15V12Zm0-9.012h-15V2.5c0-.1 0-1 1-1h13c.1 0 1 0 1 1v.488Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--powermeter-color':
      ...
      'e-icon--step_10':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Zm10.588-12c0 5.848-4.74 10.588-10.588 10.588-5.848 0-10.588-4.74-10.588-10.588C1.412 6.152 6.152 1.412 12 1.412c5.848 0 10.588 4.74 10.588 10.588Z" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/><path d="M7.251 16.76V8.57l-1.736.741V7.953l2.296-.994h.966v9.8H7.251ZM14.5 16.9c-.793 0-1.493-.21-2.1-.63-.597-.43-1.068-1.023-1.414-1.779-.336-.765-.504-1.642-.504-2.632 0-1.008.168-1.89.504-2.646.346-.756.817-1.344 1.414-1.764.607-.429 1.307-.644 2.1-.644.794 0 1.489.215 2.086.644.607.42 1.078 1.008 1.414 1.764.336.756.504 1.638.504 2.646 0 .99-.168 1.867-.504 2.632-.336.756-.807 1.35-1.414 1.778-.597.42-1.292.63-2.086.63Zm0-1.359c.504 0 .938-.149 1.302-.448.374-.308.663-.737.868-1.288.206-.55.308-1.199.308-1.946 0-.756-.102-1.409-.308-1.96-.205-.55-.494-.975-.868-1.274a1.95 1.95 0 0 0-1.302-.462c-.504 0-.942.154-1.316.462-.364.3-.653.724-.868 1.274-.205.551-.308 1.204-.308 1.96 0 .747.103 1.396.308 1.946.215.551.504.98.868 1.288.374.3.812.448 1.316.448Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--stove':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6 19.5a.75.75 0 0 1 .75.75V21a.75.75 0 0 1-1.5 0v-.75A.75.75 0 0 1 6 19.5ZM9 18a.75.75 0 0 1 .75.75V21a.75.75 0 0 1-1.5 0v-2.25A.75.75 0 0 1 9 18ZM12 19.5a.75.75 0 0 1 .75.75V21a.75.75 0 0 1-1.5 0v-.75a.75.75 0 0 1 .75-.75ZM18 19.5a.75.75 0 0 1 .75.75V21a.75.75 0 0 1-1.5 0v-.75a.75.75 0 0 1 .75-.75ZM15 18a.75.75 0 0 1 .75.75V21a.75.75 0 0 1-1.5 0v-2.25A.75.75 0 0 1 15 18ZM3.75 23.25a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 0 1.5h-15a.75.75 0 0 1-.75-.75ZM5.25 3.75A.75.75 0 0 1 6 3h12a.75.75 0 0 1 .75.75v11A1.75 1.75 0 0 1 17 16.5H7a1.75 1.75 0 0 1-1.75-1.75v-11Zm1.5.75v10.25A.25.25 0 0 0 7 15h10a.25.25 0 0 0 .25-.25V4.5H6.75Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 3.75A.75.75 0 0 1 4.5 3h15a.75.75 0 0 1 0 1.5h-15a.75.75 0 0 1-.75-.75ZM2.25 6.75A.75.75 0 0 1 3 6h3a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75ZM17.25 6.75A.75.75 0 0 1 18 6h3a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1-.75-.75Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 1.5a2.25 2.25 0 0 0-2.25 2.25.75.75 0 0 1-1.5 0 3.75 3.75 0 1 1 7.5 0 .75.75 0 0 1-1.5 0A2.25 2.25 0 0 0 12 1.5Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--subtract_circle':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 12.748a.75.75 0 1 1 0-1.498h9a.75.75 0 1 1 0 1.498h-9Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path d="M12 24C5.383 24 0 18.617 0 12S5.383 0 12 0s12 5.383 12 12-5.383 12-12 12Zm0-22.5C6.21 1.5 1.5 6.21 1.5 12S6.21 22.5 12 22.5 22.5 17.79 22.5 12 17.79 1.5 12 1.5Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--subtract_circle-filled':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 12c0 6.617 5.383 12 12 12s12-5.383 12-12S18.617 0 12 0 0 5.383 0 12Z" fill="var(--e-color-icon-filled-background-1, var(--e-color-icon-filled-background-1, #000000))"/><path d="M7.5 12.748a.75.75 0 1 1 0-1.498h9a.75.75 0 1 1 0 1.498h-9Z" fill="var(--e-color-icon-filled-foreground-1, var(--e-color-icon-filled-foreground-1, #FFFFFF))"/></svg>',
      'e-icon--subtract_circle-filled-color':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="12" fill="var(--e-color-brand-accent, var(--e-color-brand-accent, #29D305))"/><path d="M7.75 12.748a.75.75 0 1 1 0-1.498h9a.75.75 0 1 1 0 1.498h-9Z" fill="#000"/></svg>',
      'e-icon--support':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="

        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.25 16.5a.75.75 0 0 0 1.5 0v-3.75h3.75a.75.75 0 0 0 0-1.5h-3.75V7.5a.75.75 0 0 0-1.5 0v3.75H7.5a.75.75 0 0 0 0 1.5h3.75v3.75Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M0 12c0 6.617 5.383 12 12 12s12-5.383 12-12S18.617 0 12 0 0 5.383 0 12Zm1.5 0C1.5 6.21 6.21 1.5 12 1.5S22.5 6.21 22.5 12 17.79 22.5 12 22.5 1.5 17.79 1.5 12Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--tag':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.798 7.487c.747 0 1.353-.608 1.353-1.359 0-.75-.606-1.359-1.353-1.359s-1.353.609-1.353 1.36c0 .75.605 1.358 1.353 1.358Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M9.396 24c-.613 0-1.226-.205-1.634-.718L.715 16.205C.306 15.795 0 15.18 0 14.565c0-.616.204-1.232.715-1.642L12.562 1.128A3.937 3.937 0 0 1 15.319 0h6.434C22.98 0 24 1.026 24 2.256v6.462c0 1.026-.409 1.949-1.123 2.77L11.03 23.281c-.409.41-1.021.718-1.634.718Zm5.923-22.462c-.613 0-1.225.206-1.634.718L1.838 14.051a.785.785 0 0 0-.204.513c0 .205.102.41.204.513l7.047 7.077a.799.799 0 0 0 1.123 0l11.847-11.898c.409-.41.715-1.025.715-1.64v-6.36c0-.41-.306-.82-.817-.82l-6.434.102Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--third_party':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 1.45a1.55 1.55 0 1 0 0 3.1 1.55 1.55 0 0 0 0-3.1ZM.05 3a2.95 2.95 0 1 1 5.9 0 2.95 2.95 0 0 1-5.9 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M4.255 3.91a.7.7 0 0 1 .978-.156L7.16 5.152a.7.7 0 0 1-.822 1.134L4.411 4.888a.7.7 0 0 1-.156-.978ZM3 19.45a1.55 1.55 0 1 0 0 3.1 1.55 1.55 0 0 0 0-3.1ZM.05 21a2.95 2.95 0 1 1 5.9 0 2.95 2.95 0 0 1-5.9 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M7.317 17.869a.7.7 0 0 1-.156.978l-1.928 1.399a.7.7 0 0 1-.822-1.133l1.928-1.4a.7.7 0 0 1 .978.156ZM21 1.45a1.55 1.55 0 1 0 0 3.1 1.55 1.55 0 0 0 0-3.1ZM18.05 3a2.95 2.95 0 1 1 5.9 0 2.95 2.95 0 0 1-5.9 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M19.745 3.91a.7.7 0 0 1-.156.978L17.66 6.286a.7.7 0 1 1-.822-1.134l1.928-1.398a.7.7 0 0 1 .978.156ZM21 19.45a1.55 1.55 0 1 0 0 3.1 1.55 1.55 0 0 0 0-3.1ZM18.05 21a2.95 2.95 0 1 1 5.9 0 2.95 2.95 0 0 1-5.9 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path fill-rule="evenodd" clip-rule="evenodd" d="M16.683 17.869a.7.7 0 0 1 .978-.155l1.928 1.399a.7.7 0 1 1-.822 1.133l-1.928-1.4a.7.7 0 0 1-.156-.977ZM12 5.95a1.925 1.925 0 1 0 0 3.85 1.925 1.925 0 0 0 0-3.85ZM8.675 7.875a3.325 3.325 0 1 1 6.65 0 3.325 3.325 0 0 1-6.65 0Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/><path d="M12 11.95a3.8 3.8 0 0 0-3.735 3.1S8.192 16 7.5 16c-.692 0-.653-.95-.653-.95a5.2 5.2 0 0 1 10.306 0s.112.95-.653.95-.765-.95-.765-.95A3.8 3.8 0 0 0 12 11.95Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--thumbnail':
        '<svg viewBox="0 0 24 24" aria-hidden="true" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.25 0A2.25 2.25 0 0 0 0 2.25v6a2.25 2.25 0 0 0 2.25 2.25h6a2.25 2.25 0 0 0 2.25-2.25v-6A2.25 2.25 0 0 0 8.25 0h-6ZM1.5 2.25a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-.75.75h-6a.75.75 0 0 1-.75-.75v-6ZM2.25 13.5A2.25 2.25 0 0 0 0 15.75v6A2.25 2.25 0 0 0 2.25 24h6a2.25 2.25 0 0 0 2.25-2.25v-6a2.25 2.25 0 0 0-2.25-2.25h-6Zm-.75 2.25a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-.75.75h-6a.75.75 0 0 1-.75-.75v-6ZM13.5 2.25A2.25 2.25 0 0 1 15.75 0h6A2.25 2.25 0 0 1 24 2.25v6a2.25 2.25 0 0 1-2.25 2.25h-6a2.25 2.25 0 0 1-2.25-2.25v-6Zm2.25-.75a.75.75 0 0 0-.75.75v6c0 .414.336.75.75.75h6a.75.75 0 0 0 .75-.75v-6a.75.75 0 0 0-.75-.75h-6ZM15.75 13.5a2.25 2.25 0 0 0-2.25 2.25v6A2.25 2.25 0 0 0 15.75 24h6A2.25 2.25 0 0 0 24 21.75v-6a2.25 2.25 0 0 0-2.25-2.25h-6ZM15 15.75a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-.75.75h-6a.75.75 0 0 1-.75-.75v-6Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>',
      'e-icon--thumbnail-color':
    ...
    o = [
      ...
      { name: 'e-icon--arrow_external', version: '7.4.0', newIconName: 'e-icon--new_tab-bold' },
      { name: 'e-icon--arrow_external-bold', version: '7.4.0', newIconName: 'e-icon--new_tab-bold' },
      { name: 'e-icon--arrow_long', version: '6.2.0', newIconName: 'e-icon--arrow_long_right' },
      { name: 'e-icon--arrow_long-bold', version: '6.2.0', newIconName: 'e-icon--arrow_long_right-bold' },
      { name: 'e-icon--check', version: '7.5.0', newIconName: 'e-icon--check-bold' },
      { name: 'e-icon--close', version: '7.5.0', newIconName: 'e-icon--close-bold' },
      { name: 'e-icon--design_process-color', version: '7.5.0', newIconName: 'e-icon--bookshelf' },
      { name: 'e-icon--list_color', version: '12.3.0', newIconName: 'e-icon--list-color' },
      { name: 'e-icon--minus', version: '7.5.0', newIconName: 'e-icon--minus-bold' },
      { name: 'e-icon--movie', version: '10.6.0', newIconName: 'e-icon--media-color' },
      {
        name: 'e-icon--paper_plane_speed_color',
        version: '11.4.0',
        newIconName: 'e-icon--paper_plane_flying-color',
      },
      { name: 'e-icon--plus', version: '7.5.0', newIconName: 'e-icon--plus-bold' },
      { name: 'e-icon--profile-2', version: '7.5.0', newIconName: 'e-icon--profile' },
      { name: 'e-icon--profile-2-color', version: '7.5.0', newIconName: 'e-icon--profile' },
      { name: 'e-icon--settings_vertical', version: '7.14.1', newIconName: 'e-icon--configurations' },
      {
        name: 'e-icon--sorting_alfabetical_a_to_z',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_ascending-bold',
      },
      {
        name: 'e-icon--sorting_alfabetical_z_to_a',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_descending-bold',
      },
      {
        name: 'e-icon--sorting_date_earliest_to_latest',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_ascending-bold',
      },
      {
        name: 'e-icon--sorting_date_latest_to_earliest',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_descending-bold',
      },
      {
        name: 'e-icon--sorting_number_high_to_low',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_descending-bold',
      },
      {
        name: 'e-icon--sorting_number_low_to_high',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_ascending-bold',
      },
      {
        name: 'e-icon--sorting_time_earliest_to_latest',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_ascending-bold',
      },
      {
        name: 'e-icon--sorting_time_latest_to_earliest',
        version: '7.5.0',
        newIconName: 'e-icon--sorting_descending-bold',
      },
      { name: 'e-icon--tag_add', version: '7.5.0', newIconName: 'e-icon--add_circle' },
    ],
    l = [
      {
        name: 'e-text',
        version: '12.7.0',
        replacement: {
          name: 'CSS variables tokens and class tokens',
          type: 'class',
          documentation: 'https://design.elvia.io/brand/colors',
        },
        sunset: 'April 2024',
      },
      {
      ...
      },
      {
        ...
        replacement: {
          name: 'Autocomplete',
          type: 'component',
          documentation: 'https://design.elvia.io/components/autocomplete',
        },
        sunset: 'April 2024',
      },
      {
        name: 'e-autocomplete__item',
        version: '12.5.0',
        replacement: {
          name: 'Autocomplete',
          type: 'component',
      ...
      },
      {
        ...
        replacement: {
          name: 'Stepper',
          type: 'component',
          documentation: 'https://design.elvia.io/components/stepper',
        },
        sunset: 'April 2024',
      },
      {
        name: 'e-stepper__steps',
        version: '12.4.0',
        replacement: {
          name: 'Stepper',
          type: 'component',
      ...
      {
        name: 'e-stepper__step--active-done',
        version: '12.4.0',
        replacement: {
          name: 'Stepper',
          type: 'component',
      ...
      {
        name: 'e-stepper__step-number--hover',
        version: '12.4.0',
        replacement: {
          name: 'Stepper',
          type: 'component',
      ...
      { name: 'e-form-field--combined', version: '12.0.0', sunset: 'April 2024' },
      { name: 'e-form-field--medium', version: '12.0.0', sunset: 'April 2024' },
      {
        name: 'e-input--medium',
        version: '12.0.0',
        requiredAncestor: 'e-form-field--combined',
        replacement: {
          name: 'e-input--',
          type: 'class',
          documentation: 'https://design.elvia.io/components/input',
        },
        sunset: 'April 2024',
      },
      {
      ...
      {
        name: 'e-toggle--compact',
        version: '12.0.0',
        replacement: {
          name: 'e-toggle--small',
          type: 'class',
          documentation: 'https://design.elvia.io/components/toggle',
        },
        sunset: 'April 2024',
      },
      {
        name: 'e-input--compact',
        version: '12.0.0',
        replacement: {
          name: 'e-input--small',
          type: 'class',
      ...
      {
        name: 'e-checkbox--compact',
        version: '12.0.0',
        replacement: {
          name: 'e-checkbox--small',
          type: 'class',
          documentation: 'https://design.elvia.io/components/checkbox',
        },
        sunset: 'April 2024',
      },
      {
      ...
      {
        name: 'e-table__footnote--compact',
        version: '12.0.0',
        replacement: {
          name: 'e-table__footnote--small',
          type: 'class',
          documentation: 'https://design.elvia.io/components/table',
        },
        sunset: 'April 2024',
      },
      {
        name: 'e-table__cell--multiline-sm',
        version: '12.0.0',
        replacement: {
          name: 'e-table__cell--multiline-small',
          type: 'class',
          documentation: 'https://design.elvia.io/components/table',
        },
        sunset: 'April 2024',
      ...
      {
        name: 'e-table-mobile--compact',
        version: '12.0.0',
        replacement: {
          name: 'e-table-mobile--small',
          type: 'class',
          documentation: 'https://design.elvia.io/components/table',
        },
        sunset: 'April 2024',
      ...
      {
        name: 'e-form-field--compact',
        version: '12.0.0',
        replacement: {
          name: 'e-form-field--small',
          type: 'class',
          documentation: 'https://design.elvia.io/components/input',
        },
        sunset: 'April 2024',
      ...
      {
        name: 'e-radio--compact',
        version: '12.0.0',
        replacement: {
          name: 'e-radio--small',
          type: 'class',
          documentation: 'https://design.elvia.io/components/radiobutton',
        },
        sunset: 'April 2024',
      },
      {
      ...
      {
        name: 'e-content-loader--grey',
        version: '10.6.0',
        replacement: {
          name: 'e-content-loader',
          type: 'class',
          documentation: 'https://design.elvia.io/components/content-loader',
        },
        sunset: 'April 2024',
      },
    ],
    ...
    if (o2.addedNodes.length > 0)
      for (let e3 = 0; e3 < o2.addedNodes.length; e3++) {
        ...
        if (('i' === l2.localName && i(l2), l2.querySelectorAll)) {
          ...
          for (let o3 = 0; o3 < e4.length; o3++) i(e4[o3]);
        }
      }
    i(e2);
  }
  function i(o2) {
    if (o2 && o2.classList)
      for (let l2 = 0; l2 < o2.classList.length; l2++)
        e[o2.classList[l2]] &&
          n(o2) &&
          ((o2.innerHTML = v(o2.classList)), o2.setAttribute('e-id', t(o2.classList)));
  }
  function n(e2) {
    let o2 = e2.getAttribute('e-id'),
      l2 = t(e2.classList) + '';
    return !o2 || o2 + '' !== l2;
  }
  function t(e2) {
    let o2 = '';
    for (let l2 = 0; l2 < e2.length; l2++) o2 += e2[l2];
    return o2;
  }
  function v(o2) {
  ...
  a ||
    ...
    document.documentElement.addEventListener('keydown', function (e2) {
    ...
    new MutationObserver(function (e2) {
      for (let o2 = 0; o2 < e2.length; o2++) c(e2[o2].target, e2[o2]), o2 === e2.length - 1 && s();
  ...
  function s() {
    if (r) {
      const e2 = [
          ...new Set([...document.querySelectorAll('[class^="e-"]')].flatMap((e3) => [...e3.classList])),
        ].sort(),
        o2 = [];
      e2.forEach((e3) => {
        ...
        if (a2 && !h.includes(a2.name)) {
          if (
            a2.requiredAncestor &&
            !(function ({ requiredAncestor: e4, name: o3 }) {
          ...
          h.push(a2.name),
            o2.push(
              (function ({ name: e4, version: o3, replacement: l2, sunset: a3, requiredAncestor: r2 }) {
                let c2 = a3 ? `The sunset date is set for ${a3}.` : '',
                  i2 = l2
                    ? `
 
It has been replaced with the ${l2.type} '${l2.name}'. See ${l2.documentation}.`
                    : '';
                return `Deprecation warning: The Elvis ${
                  r2 ? `descendant combination (.${r2} .${e4})` : `class ${e4}`
                } has been deprecated since version ${o3}. ${c2} ${i2}`;
              })(a2),
            );
        }
      }),
        o2.length &&
          (console.group('Elvis Deprecations'), o2.forEach((e3) => console.warn(e3)), console.groupEnd());
    }
  }
  let w = 0;
  !(function () {
      ...
      I$1(c)
        ...
        : null != c &&
          (O$1(c) &&
            (c = N$1(
              c,
              e + (!c.key || (h && h.key === c.key) ? '' : ('' + c.key).replace(P$1, '$&/') + '/') + a,
            )),
          b.push(c)),
      1
    );
...
(function (exports) {
  ...
  exports.unstable_scheduleCallback = function (a, b, c) {
    ...
    c > d
      ? ((a.sortIndex = c),
        f(t, a),
        null === h(r) && a === h(t) && (B ? (E(L), (L = -1)) : (B = true), K(H, c - d)))
...
function rd(a) {
  function b(b2, d, e, f, g) {
    ...
    this.isDefaultPrevented = (null != f.defaultPrevented ? f.defaultPrevented : false === f.returnValue)
      ? pd
      : qd;
      ...
      a: {
        ...
        if (k2 || h2) {
          ...
          if (k2 !== n) {
            ...
            F = null;
            Wc(e2) === d2 &&
              ((t = new t(x, w + 'enter', n, c, e2)), (t.target = u), (t.relatedTarget = J), (F = t));
            J = F;
            if (k2 && n)
              b: {
                t = k2;
...
function vh(a) {
  ...
  function k(a2, b2, c2, d2) {
    ...
    if (
      null !== b2 &&
      (b2.elementType === f2 ||
        ('object' === typeof f2 && null !== f2 && f2.$$typeof === Ha && uh(f2) === b2.type))
    )
  ...
  function n(e2, g2, h2, k2) {
    ...
    if (null === u) {
      for (; w < h2.length; w++)
        (u = q(e2, h2[w], k2)),
          null !== u && ((g2 = f(u, g2, w)), null === m2 ? (l2 = u) : (m2.sibling = u), (m2 = u));
      I && tg(e2, w);
      return l2;
    }
  ...
  function t(e2, g2, h2, k2) {
    ...
    if (null === m2) {
      for (; !n2.done; w++, n2 = h2.next())
        (n2 = q(e2, n2.value, k2)),
          null !== n2 && ((g2 = f(n2, g2, w)), null === u ? (l2 = n2) : (u.sibling = n2), (u = n2));
      I && tg(e2, w);
      return l2;
    }
    for (m2 = d(e2, m2); !n2.done; w++, n2 = h2.next())
      (n2 = y(m2, e2, w, n2.value, k2)),
        null !== n2 &&
          (a && null !== n2.alternate && m2.delete(null === n2.key ? w : n2.key),
          (g2 = f(n2, g2, w)),
      ...
      switch (f2.$$typeof) {
        case va:
          a: {
            for (var k2 = f2.key, l2 = d2; null !== l2; ) {
              if (l2.key === k2) {
                ...
                if (k2 === ya) {
                  ...
                  l2.elementType === k2 ||
                  ('object' === typeof k2 && null !== k2 && k2.$$typeof === Ha && uh(k2) === l2.type)
                ) {
                  c(a2, l2.sibling);
                  d2 = e(l2, f2.props);
                  d2.ref = sh(a2, l2, f2);
            ...
            f2.type === ya
              ? ((d2 = Ah(f2.props.children, a2.mode, h2, f2.key)), (d2.return = a2), (a2 = d2))
    ...
    return ('string' === typeof f2 && '' !== f2) || 'number' === typeof f2
      ? ((f2 = '' + f2),
        null !== d2 && 6 === d2.tag
          ...
          : (c(a2, d2), (d2 = xh(f2, a2.mode, h2)), (d2.return = a2), (a2 = d2)),
        g(a2))
      : c(a2, d2);
  }
  return J;
  ...
  switch (b.tag) {
          ...
          for (var g in f)
            if (f.hasOwnProperty(g)) {
              ...
              'children' === g
                ? 'string' === typeof h
                  ? d.textContent !== h &&
                    (true !== f.suppressHydrationWarning && Af(d.textContent, h, a), (e = ['children', h]))
                  : 'number' === typeof h &&
                    d.textContent !== '' + h &&
    ...
    case 13:
      ...
      d !== (null !== a && null !== a.memoizedState) &&
        d &&
        ((b.child.flags |= 8192),
        0 !== (b.mode & 1) && (null === a || 0 !== (M.current & 1) ? 0 === T && (T = 3) : uj()));
        ...
        if (!d)
          if (((a = Mh(g)), null !== a)) {
            ...
            2 * B() - f.renderingStartTime > Hj &&
              1073741824 !== c &&
              ((b.flags |= 128), (d = true), Ej(f, false), (b.lanes = 4194304));
        f.isBackwards
  ...
  if (0 !== b) {
    ...
    if (6 === b) Dk(a, d);
      ...
      if (
        0 === (d & 30) &&
        !Pk(e) &&
        ((b = Jk(a, d)), 2 === b && ((f = xc(a)), 0 !== f && ((d = f), (b = Ok(a, f)))), 1 === b)
      )
...
function Zk(a, b) {
  0 === b &&
    (0 === (a.mode & 1) ? (b = 1) : ((b = sc), (sc <<= 1), 0 === (sc & 130023424) && (sc = 4194304)));
  var c = L();
  a = Zg(a, b);
...
var unstable_renderSubtreeIntoContainer = (reactDom_production_min.unstable_renderSubtreeIntoContainer =
  function (a, b, c, d) {
...
function pwRegister(components) {
  for (const [name, value] of Object.entries(components)) __pwLoaderRegistry.set(name, value);
}
...
async function __pwResolveComponent(component) {
  ...
  if (!componentFactory && component.type[0].toUpperCase() === component.type[0])
    throw new Error(
      `Unregistered component: ${component.type}. Following components are registered: ${[
        ...__pwRegistry.keys(),
      ]}`,
    );

  if (componentFactory) __pwRegistry.set(component.type, await componentFactory());
...
function __pwRender(component) {
  ...
  if (component.kind !== 'jsx') throw new Error('Object mount notation is not supported');
...
const _Users_frideskarseth_Documents_Kode_designsystem_packages_components_components_elvis_accordion_react_js_Accordion =
  () =>
    __vitePreload(
      () => import('./react-59d0e111.js'),
      true ? ['assets/react-59d0e111.js', 'assets/index-ff053e39.js'] : void 0,
    ).then((mod) => mod.Accordion);
const _Users_frideskarseth_Documents_Kode_designsystem_packages_components_components_elvis_chip_react_js_Chip =
  () =>
    __vitePreload(
      () => import('./react-cbebdb8c.js'),
      true ? ['assets/react-cbebdb8c.js', 'assets/index-ff053e39.js'] : void 0,
    ).then((mod) => mod.Chip);
const _Users_frideskarseth_Documents_Kode_designsystem_packages_components_components_elvis_datepicker_react_js_Datepicker =
  () =>
    __vitePreload(
      () => import('./react-b750fe8c.js'),
      true ? ['assets/react-b750fe8c.js', 'assets/index-ff053e39.js'] : void 0,
    ).then((mod) => mod.Datepicker);
pwRegister({
  _Users_frideskarseth_Documents_Kode_designsystem_packages_components_components_elvis_accordion_react_js_Accordion,
