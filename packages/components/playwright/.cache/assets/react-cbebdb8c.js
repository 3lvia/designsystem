...
const close = {
  getIcon: function (color) {
    const icon =
      '<svg viewBox="0 0 24 24" aria-hidden="true" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.636 2.122A1.243 1.243 0 1 0 21.878.364L12 10.242 2.122.364A1.243 1.243 0 0 0 .364 2.122L10.242 12 .364 21.878a1.243 1.243 0 1 0 1.758 1.758L12 13.758l9.878 9.878a1.243 1.243 0 1 0 1.758-1.758L13.758 12l9.878-9.878Z" fill="var(--e-color-icon-stroke-1, var(--e-color-icon-stroke-1, #000000))"/></svg>';
    if (!color) {
      return icon;
    }
    if (!color.startsWith('#') && !color.startsWith('var(--')) {
...
function $458b0a5536c1a7cf$export$40bfa8c7b0832715(value1, defaultValue, onChange) {
  ...
  let setValue = reactExports.useCallback(
    (value2, ...args) => {
...
const $704cf1d3b684cc5c$var$SSRContext = /* @__PURE__ */ React.createContext(
  $704cf1d3b684cc5c$var$defaultContext,
);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  ...
  return /* @__PURE__ */ React.createElement(
    $704cf1d3b684cc5c$var$SSRContext.Provider,
    {
      value,
    },
    props.children,
...
let $704cf1d3b684cc5c$var$canUseDOM = Boolean(
...
function $9cc09df9fd7676be$export$7bbed75feba39706(props) {
  ...
  let getNextOffset = (e) => {
    let containerOffset = $ab71dadb03a6fb2e$export$622cea445a1c5b7d(
...
function $03deb23ff14920c4$export$4eaf04e54aa8eed6() {
  ...
  let removeGlobalListener = reactExports.useCallback((eventTarget, type, listener, options) => {
    var ref;
    let fn =
      ((ref = globalListeners.current.get(listener)) === null || ref === void 0 ? void 0 : ref.fn) ||
      listener;
...
function $313b98861ee5dd6c$export$d6875122194c7b44(props, defaultLabel) {
  ...
  if (labelledBy && label) {
    let ids = /* @__PURE__ */ new Set([...labelledBy.trim().split(/\s+/), id]);
    labelledBy = [...ids].join(' ');
...
function $5df64b3807dc15ee$export$d699905dd57c73ca() {
  let [size1, setSize] = reactExports.useState(() => $5df64b3807dc15ee$var$getViewportSize());
  reactExports.useEffect(() => {
    let onResize = () => {
      setSize((size) => {
...
function $5df64b3807dc15ee$var$getViewportSize() {
  return {
    width:
      ($5df64b3807dc15ee$var$visualViewport === null || $5df64b3807dc15ee$var$visualViewport === void 0
        ? void 0
        : $5df64b3807dc15ee$var$visualViewport.width) || window.innerWidth,
    height:
      ($5df64b3807dc15ee$var$visualViewport === null || $5df64b3807dc15ee$var$visualViewport === void 0
        ? void 0
        : $5df64b3807dc15ee$var$visualViewport.height) || window.innerHeight,
  };
}
...
function $c87311424ea30a05$var$testUserAgent(re) {
  ...
  return (
    ((ref = window.navigator['userAgentData']) === null || ref === void 0
      ? void 0
      : ref.brands.some((brand) => re.test(brand.brand))) || re.test(window.navigator.userAgent)
  );
}
function $c87311424ea30a05$var$testPlatform(re) {
  ...
  return typeof window !== 'undefined' && window.navigator != null
    ? re.test(
        ((ref = window.navigator['userAgentData']) === null || ref === void 0 ? void 0 : ref.platform) ||
...
function $c87311424ea30a05$export$7bef049ce92e4224() {
  return (
    $c87311424ea30a05$var$testPlatform(/^iPad/i) ||
...
function $1dbecbe27a04f9af$export$14d238f342723f25(defaultValue) {
  ...
  let queue = reactExports.useCallback(
    (fn) => {
      ...
      onClick(e) {
        ...
        if (e && e.button === 0) {
          ...
          if (
            ...
            (state.pointerType === 'virtual' || $6a7db85432448f7f$export$60278871457622de(e.nativeEvent))
          ) {
...
function $f6c31cce2adf654f$var$isValidKeyboardEvent(event, currentTarget) {
  ...
  return (
    ...
    !(
      (element instanceof HTMLInputElement && !$f6c31cce2adf654f$var$isValidInputKey(element, key)) ||
...
const $3b117e43dc0ca95d$export$27c701ed9e449e99 = /* @__PURE__ */ React.forwardRef(
  ({ children, ...props }, ref) => {
...
const $f1ab8c75478c6f73$export$3351871ee4b288b8 = /* @__PURE__ */ React.forwardRef(
  ({ children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(
      $ae1eeba8b9eafd08$export$5165eccb35aaadb5.Provider,
      {
        value: context,
      },
      children,
...
function $8a9cb279dc87e130$export$715c682d09d639cc(onBlur) {
  ...
  return reactExports.useCallback((e1) => {
    if (
      e1.target instanceof HTMLButtonElement ||
      e1.target instanceof HTMLInputElement ||
      e1.target instanceof HTMLTextAreaElement ||
      e1.target instanceof HTMLSelectElement
    ) {
      ...
      let onBlurHandler = (e) => {
        ...
        if (target.disabled)
          (ref = (_current = stateRef.current).onBlur) === null || ref === void 0
            ? void 0
            : ref.call(_current, new $8a9cb279dc87e130$export$905e7fc544a71f36('blur', e));
...
function $507fabe10e71c6fb$export$ffd9e5021c1fb2d6(props = {}) {
  ...
  $507fabe10e71c6fb$export$ec71b4b83ac08ec3(
    ($507fabe10e71c6fb$export$b9b3dfddab17db272) => {
...
function $7d0a636d7a4dcefd$export$2123ff2b87c81ca(props, ref) {
  ...
  let onScrollHandler = reactExports.useCallback(
    (e) => {
      if (e.ctrlKey) return;
      e.preventDefault();
      e.stopPropagation();
...
var chipColors = function (a) {
  ...
  getChipBackgroundLight = function (a, b, c, d, e, f) {
    switch (f) {
      ...
      case 'choice':
        if (b && c) return setOpacity(chipColors('green'), 20);
        return b ? setOpacity(chipColors('green'), 30) : 'transparent';
      case 'legend':
        if (b && c && !e) return setOpacity(chipColors(a), 20);
  ...
  getChipBorderDark = function (a, b, c, d, e, f) {
    switch (f) {
      case 'removable':
        if (c) return ''.concat(setOpacity(chipColors(a, 'dark'), 30));
        return d ? 'transparent' : ''.concat(chipColors(a, 'dark'));
      case 'choice':
        if (b && d) return ''.concat(setOpacity(chipColors('green', 'dark'), 80));
        return b ? ''.concat(chipColors('green', 'dark')) : ''.concat(L('grey-60', 'dark'));
      case 'legend':
        if (b && d && !e) return ''.concat(setOpacity(chipColors(a, 'dark'), 80));
        return b && !e ? ''.concat(chipColors(a, 'dark')) : ''.concat(L('grey-60', 'dark'));
    }
  },
  getCursor = function (a, b) {
    if (a) return 'not-allowed';
    return b ? 'wait' : 'pointer';
  };
var ChipComponent = He.button.withConfig({
  displayName: 'styledComponents__ChipComponent',
  componentId: 'sc-9hr7jf-0',
})(
  [
    'position:relative;display:flex;flex-direction:row;gap:8px;align-items:center;border:solid 1px ',
    ';background-color:',
    ';padding:7px 15px;border-radius:24px;transition:background-color 150ms ease-in;white-space:nowrap;cursor:',
    ';.e-color-background-3 &&,.e-theme-dark &&{border:solid 1px ',
    ';transition:border 150ms ease-in;background-color:transparent;&:hover{background-color:',
    ';}}',
  ],
  function (a) {
    var b = a.isLoading,
...
var ChipLoading = He.div.withConfig({
  displayName: 'styledComponents__ChipLoading',
  componentId: 'sc-9hr7jf-1',
})(
  [
    'position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);> span{width:10px;height:10px;background-color:',
    ';border-radius:100%;display:inline-block;animation:',
    ' 1s infinite ease-in-out both;}> span:nth-of-type(1){animation-delay:-0.32s;}> span:nth-of-type(2){animation-delay:-0.16s;}',
  ],
  function (a) {
    var b = a.color;
    return chipColors(b);
...
var ChipDot = He.span.withConfig({ displayName: 'styledComponents__ChipDot', componentId: 'sc-9hr7jf-2' })(
  [
    'display:inline-block;height:10px;width:10px;border-radius:50%;transition:background-color 150ms ease-in;background-color:',
    ';opacity:',
    ';visibility:',
    ';',
  ],
...
var ChipTitle = He.div.withConfig({ displayName: 'styledComponents__ChipTitle', componentId: 'sc-9hr7jf-3' })(
  [
    "font-family:'Red Hat Display',Verdana,sans-serif;font-weight:500;font-size:14px;line-height:16px;text-transform:'unset';letter-spacing:'unset';font-style:unset;transition:opacity 150ms ease-in;visibility:",
    ';',
  ],
  function (a) {
    var b = a.isHidden;
...
var Chip = function (a) {
  var b = a.ariaLabel,
    ...
    i = void 0 !== h && h,
    j = a.type,
    k = void 0 === j ? 'removable' : j,
    l = a.value,
    m = a.onDelete,
    n = a.isSelectedOnChange,
    o = a.className,
    p = a.inlineStyle,
    q = a.webcomponent,
    r = _objectWithoutProperties(a, _excluded),
    s = useWebComponentState(void 0 !== g && g, 'isSelected', q, n),
    ...
    x = function () {
      if (f) return E('text-disabled-1');
      return 'removable' === k && A ? E('static-black') : E('text-1');
    },
    y = $6179b936705e76d3$export$ae780daf29e6d456({}),
    z = y.hoverProps,
    A = y.isHovered;
  return /* @__PURE__ */ React.createElement(
    ChipComponent,
    ...
    'choice' === k &&
      /* @__PURE__ */ React.createElement(IconWrapper, {
        icon: check,
        size: '12px',
        color: u || A ? 'text-1' : 'border-4',
      }),
    'legend' === k &&
      /* @__PURE__ */ React.createElement(ChipDot, { color: d, showDot: A || u, isDisabled: f, isHidden: i }),
    i &&
    ...
    'removable' === k &&
      /* @__PURE__ */ React.createElement(IconWrapper, { icon: close, size: 'xxs', color: x() }),
  );
};
const Chip$1 = Chip;
