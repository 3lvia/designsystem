...
export const appList = [
  ...
  },
  {
    ...
    <circle cx="20" cy="20" r="20" transform="rotate(-90 20 20)" fill="${getThemeColor('signal-success')}"/>
  ...
  },
  {
    name: 'MSIc',
    icon: `<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20" cy="20" r="20" transform="rotate(-180 20 20)" fill="${getThemeColor('signal-success')}"/>
