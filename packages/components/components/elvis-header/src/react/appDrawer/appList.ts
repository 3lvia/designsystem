...
export const appList: AppLink[] = [
  {
    name: 'Bildegjennomgang',
    icon: `<svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20.019" cy="20.0019" r="19.9966" transform="rotate(-180 20.019 20.0019)" fill="#29D305"/>
  ...
  },
  {
    ...
    <circle cx="20.1104" cy="20.2187" r="19.9991" transform="rotate(-90 20.1104 20.2187)" fill="#29D305"/>
  ...
  },
  {
    name: 'Elflow',
    icon: `<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20.0572" cy="20.0925" r="19.9703" transform="rotate(-90 20.0572 20.0925)" fill="#29D305"/>
  ...
  },
  {
    ...
    <circle cx="20" cy="20.0979" r="20" transform="rotate(180 20 20.0979)" fill="#29D305"/>
  ...
  },
  {
    name: 'Jordfeil',
    icon: `<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20.0157" cy="20.1472" r="19.9993" transform="rotate(-90 20.0157 20.1472)" fill="#29D305"/>
  ...
  },
  {
    ...
    icon: `<svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="19.9992" cy="20.0921" r="19.9992" transform="rotate(-90 19.9992 20.0921)" fill="#29D305"/>
  ...
  },
  {
    name: 'Louvre',
    icon: `<svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20.9969" cy="20.004" r="19.9703" transform="rotate(180 20.9969 20.004)" fill="#29D305"/>
  ...
  },
  {
    name: 'MDMx',
    icon: `<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20.0447" cy="20.4188" r="19.9703" transform="rotate(22.2482 20.0447 20.4188)" fill="#29D305"/>
  ...
  //   name: 'MMM',
  //   icon: `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  //   <circle cx="19.994" cy="20.004" r="19.9703" transform="rotate(180 19.994 20.004)" fill="#29D305"/>
  //   <path fill-rule="evenodd" clip-rule="evenodd" d="M2.8357 9.73137C8.42711 10.4924 14.1355 10.8855 19.9357 10.8855C25.7775 10.8855 31.5261 10.4867 37.1558 9.71497C38.961 12.7198 39.999 16.238 39.999 19.9987C39.999 31.0434 31.0455 39.997 20.0007 39.997C8.95592 39.997 0.00236511 31.0435 0.00236511 19.9987C0.00236419 16.2449 1.03661 12.7326 2.8357 9.73137Z" fill="#262626"/>
  //   </svg>`,
  //   iconLetters: 'Mm',
  //   url: 'markedsmeldingsmotor',
  // },
  {
    name: 'MSIc',
    icon: `<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    name: 'MSIm',
    icon: `<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="20.7485" cy="20.0371" r="19.9703" transform="rotate(180 20.7485 20.0371)" fill="#29D305"/>
  ...
  },
  {
    name: 'USLA',
    icon: `<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="19.9999" cy="20.0435" rx="19.9999" ry="19.9999" transform="rotate(-90 19.9999 20.0435)" fill="#29D305"/>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.1123 39.8335C14.1309 28.6083 9.63308 18.0004 3.85131 8.242C5.92721 5.39955 8.78061 3.06871 12.2646 1.6085C22.4536 -2.66196 34.1773 2.1311 38.4503 12.3141C42.7232 22.4971 37.9273 34.2139 27.7384 38.4843C24.256 39.9439 20.5944 40.3447 17.1123 39.8335Z" fill="#262626"/>
    </svg>`,
    iconLetters: 'Us',
    url: 'usla',
  },
