...
module.exports = [
  ...
  { name: 'charging_battery', terms: ['charge', 'load','electricity'], thirdparty: { name: ['streamline'] } },
  ...
  { 
    ...
    terms: ['breakdown', 'energy', 'street lightning', 'high tension', 'cutout', 'pole', 'power off','electricity'], 
    thirdparty: { name: ['streamline'] } },
  {
  ...
  { name: 'powerline', terms: ['cable', 'power', 'cord', 'electricity', 'wire'], thirdparty: { name: ['streamline'] } },
  { name: 'powerline-color', terms: ['cable', 'power', 'cord', 'electricity', 'wire'], thirdparty: { name: ['streamline'], duplicate: ['powerline'] } },
  ...
  { name: 'smart_city', terms: ['electricity'], thirdparty: { name: ['streamline'], duplicate: ['smart_city-color'] } },
  { name: 'smart_city-color', terms: ['electricity'], thirdparty: { name: ['streamline'] } },
  { name: 'solar_panel', terms: ['energy', 'power', 'cell', 'sunlight', 'electricity'], thirdparty: { name: ['streamline'] } },
  { name: 'solar_panel-color', terms: ['energy', 'power', 'cell', 'sunlight', 'electricity'], thirdparty: { name: ['streamline'], duplicate: ['solar_panel'] } },
  {
