...
module.exports = [
  ...
  { name: 'contract', terms: [], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'dislike', terms: ['thumbs down', 'vote', 'hand'] },
  ...
  { name: 'like', terms: ['thumbs up', 'vote', 'hand'] },
  ...
  { name: 'list-color', terms: [], thirdparty: { name: ['streamline'], duplicate: ['list'] } },
