...
module.exports = [
  ...
  { name: 'add_powermeter', terms: ['usage'], thirdparty: { name: ['streamline'] } },
  {
  ...
  { name: 'business-color', terms: ['factory'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'calendar', terms: ['date', 'time'], thirdparty: { name: ['streamline'] } },
  { name: 'calendar_clock-color', terms: ['date', 'time'], thirdparty: { name: ['streamline'] } },
  {
    name: 'calendar-color',
    terms: ['date', 'time'],
    thirdparty: { name: ['streamline'], duplicate: ['calendar'] },
  },
  { name: 'call', terms: ['phone', 'mobile', 'telephone'], thirdparty: { name: ['streamline'] } },
  { name: 'car-color', terms: ['van'] },
  { name: 'car_charger-color', terms: ['van'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'check-bold', terms: ['confirm'], thirdparty: { name: ['streamline'] } },
  { name: 'check_circle', terms: ['confirm'], thirdparty: { name: ['streamline'] } },
  {
  ...
  { name: 'cog', terms: ['settings', 'gear'], thirdparty: { name: ['streamline'] } },
  {
    name: 'cog-color',
    terms: ['settings', 'gear'],
    thirdparty: { name: ['streamline'], duplicate: ['cog'] },
  },
  { name: 'cog_hand_give', terms: ['api', 'technology', 'system'], thirdparty: { name: ['streamline'] } },
  {
    name: 'columns',
    terms: ['table', 'row', 'pillars', 'show', 'hide', 'data'],
    thirdparty: { name: ['streamline'], duplicate: ['list'] },
  },
  { name: 'contract', terms: ['file'], thirdparty: { name: ['streamline'] } },
  { name: 'cookie', terms: ['cookies'], thirdparty: { name: ['streamline'] } },
  {
    name: 'cost_cut-color',
    terms: ['graph', 'chart', 'bar', 'reduce', 'money', 'save'],
    thirdparty: { name: ['streamline'] },
  },
  { name: 'collapse_circle-color', terms: ['accordion'], thirdparty: { name: ['streamline'] } },
  {
    name: 'collapse_circle-filled-color',
    terms: ['accordion'],
    thirdparty: { name: ['streamline'], duplicate: ['collapse_circle-color'] },
  },
  { name: 'community', terms: ['people', 'users', 'group', 'human'], thirdparty: { name: ['streamline'] } },
  {
    name: 'compass',
  ...
  { name: 'copy', terms: ['kopier'], thirdparty: { name: ['streamline'] } },
  { name: 'crane', terms: ['hook', 'building', 'tower'], thirdparty: { name: ['streamline'] } },
  { name: 'credit_card', terms: ['money', 'pay'], thirdparty: { name: ['streamline'] } },
  {
  ...
  { name: 'dead_wood', terms: ['biodiversity', 'line clearing', 'bug', 'termite'] },
  {
    ...
    terms: ['circle', 'dots'],
    thirdparty: { name: ['streamline'], duplicate: ['dashboard'] },
  },
  { name: 'decent', terms: ['star', 'kind', 'user', 'human'], thirdparty: { name: ['streamline'] } },
  { name: 'design_process-color', deprecated: '7.5.0', newIconName: 'bookshelf' },
  { name: 'digging-color', terms: ['excavator'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'elsmart-color', terms: ['laptop', 'pc'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'expand_circle-color', terms: ['accordion'], thirdparty: { name: ['streamline'] } },
  {
  ...
  { name: 'fearless', terms: ['hero', 'super', 'taylor swift'], thirdparty: { name: ['streamline'] } },
  { name: 'feedback', terms: ['smiley'], thirdparty: { name: ['streamline'] } },
  { name: 'feedback-filled-color', terms: ['smiley'], thirdparty: { name: ['streamline'] } },
  { name: 'filter', terms: ['sort', 'funnel'], thirdparty: { name: ['streamline'] } },
  {
    name: 'filter-filled',
    terms: ['sort', 'funnel'],
    thirdparty: { name: ['streamline'], duplicate: ['filter'] },
  },
  { name: 'flag', terms: [], thirdparty: { name: ['streamline'] } },
  { name: 'flag-bold', terms: [], thirdparty: { name: ['streamline'], duplicate: ['flag'] } },
  { name: 'flag-bold-color', terms: ['pride'], thirdparty: { name: ['streamline'], duplicate: ['flag'] } },
  { name: 'flag-color', terms: ['pride'], thirdparty: { name: ['streamline'], duplicate: ['flag'] } },
  ...
  { name: 'graph_bar', terms: ['chart', 'line'], thirdparty: { name: ['streamline'] } },
  {
    name: 'graph_bar-color',
    terms: ['chart', 'line'],
    thirdparty: { name: ['streamline'], duplicate: ['graph_bar'] },
  },
  { name: 'graph_down', terms: ['chart', 'line'], thirdparty: { name: ['streamline'] } },
  {
    name: 'graph_down-color',
    terms: ['chart', 'line'],
    thirdparty: { name: ['streamline'], duplicate: ['graph_down'] },
  },
  ...
  { name: 'hammer_wrench-color', terms: ['tool'] },
  { name: 'han', terms: ['HAN-port'], thirdparty: { name: ['streamline'] } },
  { name: 'han-color', terms: ['HAN-port'], thirdparty: { name: ['streamline'], duplicate: ['han'] } },
  {
    name: 'hand_pointer',
  ...
  { name: 'home', terms: ['house'], thirdparty: { name: ['streamline'] } },
  { name: 'home-color', terms: ['house'], thirdparty: { name: ['streamline'], duplicate: ['home'] } },
  { name: 'home_office', terms: ['desk', 'work'], thirdparty: { name: ['streamline'] } },
  { name: 'house_rebuilding-color', terms: ['renovate', 'hammer'], thirdparty: { name: ['streamline'] } },
  {
    name: 'image',
  ...
  { name: 'image_add-color', terms: ['picture', 'upload'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'link', terms: ['chain'], thirdparty: { name: ['streamline'] } },
  { name: 'list', terms: ['ol', 'ul'], thirdparty: { name: ['streamline'] } },
  {
    name: 'list_color',
    deprecated: '12.3.0',
    newIconName: 'list-color',
    terms: [],
    thirdparty: { name: ['streamline'], duplicate: ['list'] },
  },
  { name: 'list-color', terms: ['ol', 'ul'], thirdparty: { name: ['streamline'], duplicate: ['list'] } },
  { name: 'list_bullets-bold', terms: [], thirdparty: { name: ['streamline'] } },
  { name: 'loading', terms: ['async', 'pending', 'wait'], thirdparty: { name: ['streamline'] } },
  { name: 'lock', terms: ['secure', 'encrypted'], thirdparty: { name: ['streamline'] } },
  {
    name: 'lock_hierarchy',
    terms: ['lock', 'hierarchy', 'closed', 'nodes'],
    thirdparty: { name: ['streamline'] },
  },
  { name: 'logout', terms: ['arrow', 'circle', 'leave', 'exit'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'menu', terms: ['hamburger'], thirdparty: { name: ['streamline'] } },
  { name: 'menu-bold', terms: ['hamburger'], thirdparty: { name: ['streamline'], duplicate: ['menu'] } },
  ...
  { name: 'open', terms: ['hands', 'heart'], thirdparty: { name: ['streamline'] } },
  { name: 'open_menu', terms: ['arrow'], thirdparty: { name: ['streamline'] } },
  {
    name: 'office',
    terms: ['work', 'building', 'business', 'corporate'],
    thirdparty: { name: ['streamline'] },
  },
  {
    name: 'office-color',
    terms: ['work', 'building', 'business', 'corporate'],
    thirdparty: { name: ['streamline'], duplicate: ['office'] },
  },
  {
  ...
  { name: 'person_add', terms: ['user', 'assign'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'pie_chart', terms: ['graph'], thirdparty: { name: ['streamline'] } },
  {
  ...
  { name: 'play_circle-color', terms: ['start', 'go', 'video'], thirdparty: { name: ['streamline'] } },
  {
    name: 'play_circle-filled-color',
    terms: ['start', 'go', 'video'],
  ...
  { name: 'profile', terms: ['person', 'human', 'user'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'reset', terms: ['arrow'], thirdparty: { name: ['streamline'] } },
  ...
  {
    name: 'sync',
    terms: ['update', 'synchronization', 'refresh', 'reload', 'arrows'],
    thirdparty: { name: ['streamline'] },
  },
  { name: 'tag_add', deprecated: '7.5.0', newIconName: 'add_circle' },
  { name: 'tag', terms: ['mark'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'touch_finger-color', terms: ['point', 'circle'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'unlock', terms: ['padlock'], thirdparty: { name: ['streamline'] } },
  { name: 'upload', terms: ['padlock'], thirdparty: { name: ['streamline'] } },
  ...
  { name: 'web_library-color', terms: ['book'], thirdparty: { name: ['streamline'] } },
  {
    name: 'worker',
  ...
  {
    name: 'work_under_line-color',
    terms: ['human', 'person', 'helmet', 'user'],
    thirdparty: { name: ['streamline'] },
  },
  {
    name: 'worker-color',
  ...
  { name: 'zoom_in', terms: ['magnifier'], thirdparty: { name: ['streamline'] } },
  { name: 'zoom_out', terms: ['magnifier'], thirdparty: { name: ['streamline'] } },
];
