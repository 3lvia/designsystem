...
module.exports = [
  ...
  { name: 'arrow_right_circle', terms: ['long', 'next', 'forward'] },
  { name: 'arrow_left_circle', terms: ['long', 'back', 'previous', 'backward'] },
  ...
  { name: 'arrow_left', terms: [] },
  { name: 'arrow_left-bold', terms: [] },
  { name: 'arrow_long_left', terms: ['back', 'backward', 'previous'] },
  ...
  { name: 'power_service', terms: ['electricity', 'warning', 'connect', 'disconnect', 'contact'] },
