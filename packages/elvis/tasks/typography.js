const typographyConfig = require('@elvia/elvis-typography/src/elviaTypography');
const fs = require('fs');
...
// MAKE CHANGES TO TYPOGRAPHY VARIABLES IN TYPOGRAPHY.TEMPLATE.SCSS or to the elvis-typography package
