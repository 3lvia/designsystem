document.addEventListener('DOMContentLoaded', function () {
  ...
  let icons = {
     ...
     "e-icon--fearless":"data:image/svg+xml,%3csvg viewBox='0 0 24 24' aria-hidden='true' width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cg clip-path='url(%23a)' fill='black'%3e%3cpath d='M13.87 24c-4.51-.16-8.12-3.77-8.28-8.22V9.75c0-.41.34-.75.75-.75s.75.34.75.75v6c.13 3.64 3.11 6.62 6.78 6.75 3.62-.13 6.59-3.11 6.72-6.78v-4.73c-2.25-.93-3.29-.66-5.18 1.18-.88.85-2.26.85-3.13 0-.34-.33-.7-.64-1.07-.93a.749.749 0 1 1 .91-1.19c.42.32.82.67 1.2 1.04.29.28.75.28 1.04 0 2.46-2.39 4.16-2.69 7.29-1.28.27.12.44.39.44.68v5.25c-.16 4.48-3.77 8.09-8.22 8.25V24Z'/%3e%3cpath d='M17.21 17.2c-.89 0-1.88-.27-2.96-.96a.76.76 0 0 0-.82 0c-3.49 2.26-6.06-.05-7.59-1.43a.756.756 0 0 1-.06-1.06c.28-.31.75-.33 1.06-.06 1.84 1.66 3.44 2.8 5.77 1.29.74-.48 1.7-.48 2.45 0 2.37 1.54 3.97.37 5.54-1.07l.24-.22c.31-.28.78-.25 1.06.05.28.31.25.78-.05 1.06l-.23.21c-.86.79-2.38 2.19-4.41 2.19Z'/%3e%3cpath d='M16.84 14.25c-.28 0-.54-.15-.67-.42a.745.745 0 0 1 .34-1.01l1.5-.75c.37-.19.82-.03 1.01.34.19.37.04.82-.34 1.01l-1.5.75a.8.8 0 0 1-.33.08h-.01ZM10.84 14.25c-.11 0-.23-.03-.33-.08l-1.5-.75a.763.763 0 0 1-.34-1.01c.19-.37.64-.52 1.01-.34l1.5.75c.37.19.52.64.34 1.01-.13.26-.4.42-.67.42h-.01ZM21.34 11.25c-.41 0-.75-.34-.75-.75V6.67c0-2.48-1.18-3.83-3.93-4.52-4.78-1.2-6.81-.47-8.43.11-1.32.47-2.57.92-4.63.1-.14.32-.14.67 0 1.08.39 1.16 1.97 2.58 3.96 2.93 1.22.22 2.97.11 4.38-1.66a.748.748 0 0 1 1.17.93c-1.46 1.83-3.53 2.61-5.82 2.2-2.34-.42-4.5-2.08-5.12-3.94-.36-1.11-.14-2.18.63-3a.73.73 0 0 1 .87-.16c1.85.89 2.68.59 4.06.1C9.45.22 11.8-.62 17.03.69c3.41.85 5.07 2.81 5.07 5.98v3.83c0 .41-.34.75-.75.75h-.01ZM14 21h-.19c-.92.05-1.92-.28-2.69-.92a.757.757 0 0 1-.1-1.06c.26-.32.74-.36 1.06-.1.49.4 1.1.61 1.74.58.7.03 1.32-.18 1.81-.58.32-.26.79-.22 1.06.1.26.32.22.79-.1 1.06-.73.6-1.63.93-2.57.93L14 21Z'/%3e%3c/g%3e%3cdefs%3e%3cclipPath id='a'%3e%3cpath fill='white' d='M0 0h24v24H0z'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e",
    ...
    ,{
        name: "e-icon--movie",
        version: "10.6.0",
        newIconName: "e-icon--media-color"
      }
    ,{
        name: "e-icon--plus",
        version: "7.5.0",
