document.addEventListener('DOMContentLoaded', function () {
  ...
  let icons = {
     ...
     "e-icon--link":"data:image/svg+xml,%3csvg viewBox='0 0 24 24' aria-hidden='true' width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='M18.663 0a5.342 5.342 0 0 0-3.776 1.563l-2.22 2.22-.002.001a5.313 5.313 0 0 0-1.539 4.057.9.9 0 0 0 1.797-.105 3.512 3.512 0 0 1 1.017-2.682l2.22-2.218a3.542 3.542 0 0 1 6.044 2.502c0 .938-.373 1.839-1.037 2.502l-2.22 2.219a3.514 3.514 0 0 1-2.685 1.02.9.9 0 1 0-.103 1.797 5.314 5.314 0 0 0 4.06-1.544l2.22-2.22A5.333 5.333 0 0 0 24 5.338 5.333 5.333 0 0 0 18.663 0Z' fill='black'/%3e%3cpath d='M17.82 6.186a.9.9 0 0 1 0 1.273L7.457 17.815a.9.9 0 0 1-1.273-1.273L16.547 6.187a.9.9 0 0 1 1.272 0Z' fill='black'/%3e%3cpath d='M5.65 11.463a5.315 5.315 0 0 1 2.195-.339.9.9 0 1 1-.104 1.796 3.514 3.514 0 0 0-2.684 1.02l-2.22 2.22a3.538 3.538 0 0 0 2.504 6.04c.939 0 1.84-.372 2.503-1.036l2.22-2.218a3.514 3.514 0 0 0 1.021-2.683.9.9 0 0 1 1.797-.104 5.308 5.308 0 0 1-1.544 4.058l-2.22 2.22A5.342 5.342 0 0 1 0 18.662c0-1.416.563-2.773 1.564-3.774l2.22-2.22a5.316 5.316 0 0 1 1.866-1.205Z' fill='black'/%3e%3c/svg%3e",
