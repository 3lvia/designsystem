...
export const eCommunity: EItems[] = [
  ...
  },
  {
    ...
    <a onclick="event.stopPropagation();" class="e-link e-link--inline e-link--new-tab" href="https://hafslundnett.slack.com/archives/C01302LBTC2" target="_blank" >
