...
import { GetStartedStartComponent } from './get-started-start.component';
...
@NgModule({
  ...
  declarations: [GetStartedStartComponent],
  exports: [GetStartedStartComponent],
})
export class GetStartedStartModule {}
