...
`;
  ...
  <button class="e-btn e-btn--danger e-btn--loading e-m-8" aria-label="Loading button" aria-live="polite" aria-busy="true">
    <span></span>
    <span></span>
    <span></span>
  </button>
...
`;
  ...
  <button class="e-btn e-btn--danger e-btn--loading e-btn--inverted e-m-8" aria-label="Loading button" aria-live="polite" aria-busy="true">
    <span></span>
    <span></span>
    <span></span>
  </button>
