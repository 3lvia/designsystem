...
export const tooltipData: ComponentData = {
  ...
  codeReact: `<Tooltip message="I'm a tooltip!">
  ...
  codeAngular: `<elvia-tooltip message="I'm a tooltip!">
  <button slot="trigger" class="e-btn e-btn--icon e-btn--lg" aria-label="Vis tooltip">
    <span class="e-btn__icon">
      <i class="e-icon e-icon--star" aria-hidden="true"></i>
    </span>
  ...
  codeVue: `<elvia-tooltip message="I'm a tooltip!">
  <button slot="trigger" class="e-btn e-btn--icon e-btn--lg" aria-label="Vis tooltip">
    <span class="e-btn__icon">
      <i class="e-icon e-icon--star" aria-hidden="true"></i>
    </span>
  ...
  codeNativeHTML: `<elvia-tooltip message="I'm a tooltip!">
  <button slot="trigger" class="e-btn e-btn--icon e-btn--lg" aria-label="Vis tooltip">
    <span class="e-btn__icon">
      <i class="e-icon e-icon--star" aria-hidden="true"></i>
    </span>
