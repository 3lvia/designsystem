...
`;
  ...
  <li>
    <span class="e-list__icon"><i class="e-icon e-icon e-icon--powermeter_ams e-icon--md" aria-label="hidden" aria-hidden="true"></i></span>
    <strong>` +
  ...
  <li>
    <span class="e-list__icon"><i class="e-icon e-icon e-icon--han-color e-icon--md" aria-label="hidden" aria-hidden="true"></i></span>
    <strong>` +
  ...
  <li>
    <span class="e-list__icon"><i class="e-icon e-icon e-icon--powermeter_old e-icon--md" aria-label="hidden" aria-hidden="true"></i></span>
    <strong>` +
