...
export const timepickerData: ComponentData = {
  ...
  attributes: {
    ...
    isErrorState: {
      isRequired: false,
      type: 'boolean',
      description: 'Forces red border on the timepicker input.',
      default: 'false',
      cegDisplayName: 'Is error state',
      cegType: 'boolean',
      cegFormType: 'checkbox',
      cegOption: 'true',
      cegDisplayGroup: 'Options',
    ...
    showValidationState: {
      isRequired: false,
      type: 'boolean',
      description: 'Disables the error text below the time picker.',
      default: 'true',
      cegDisplayName: 'Show validation state',
      cegType: 'boolean',
      cegDefault: true,
      cegFormType: 'checkbox',
      cegOption: 'false',
    ...
    customError: {
      ...
      type: 'string',
      description:
        'Custom error text that is displayed below the time picker. When set, the error is always visible.',
      cegDisplayName: 'Custom error',
      cegType: 'string',
