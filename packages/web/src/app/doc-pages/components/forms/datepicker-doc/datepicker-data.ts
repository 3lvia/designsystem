const datepickerData = {
  ...
  attributes: {
    ...
    hasClearButton: {
      isRequired: false,
      type: 'boolean',
      description: 'Show a button to clear the chosen date inside the datepicker.',
      default: 'false',
      cegDisplayName: 'Clear date button',
      cegType: 'boolean',
      cegDefault: false,
      cegFormType: 'checkbox',
      cegOption: 'true',
    ...
    clearButtonText: {
      ...
      type: 'string',
      default: 'Nullstill',
      description: 'Text to display in optional clear button.',
    },
    hasSelectDateOnOpen: {
      isRequired: false,
      type: 'boolean',
