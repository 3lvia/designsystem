const modalInfoCode = {
  ...
  codeNativeHTML: `<button id="example-modal-button-info" class="e-btn">Åpne modal</button>
  <elvia-modal
    id="example-elvia-modal-info"
  >
    <div slot="content">
      <div>Body text comes here and can go over several lines. It looks like this when it is two lines.</div>
    </div>
  ...
  `,
  codeNativeScript: `  const modal = document.getElementById('example-elvia-modal-info');
    const button = document.getElementById('example-modal-button-info');
