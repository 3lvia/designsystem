...
import * as template from 'html-loader!./autocomplete-ceg.component.html';
...
export class AutocompleteCegComponent implements StaticComponentExample {
  ...
  onClick(event: Event): void {
    ...
    if (!['country-input', 'country-options'].includes(target?.id || '')) {
  ...
  onSearch(searchTerm: string): void {
    ...
    this.showResults = searchTerm.length > 0 && this.results.length > 0;
  }
