  ...
  cegContent = new CegControlManager<BaseAccordionProps>([
    {
      ...
      controls: {
        ...
        closeLabel: { type: 'text', group: 'Label When Open', label: 'Label when open', value: 'Skjul' },
        openLabel: { type: 'text', group: 'Label When Closed', label: 'Label when closed', value: 'Vis' },
      },
