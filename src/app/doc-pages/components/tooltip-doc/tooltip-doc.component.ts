...
export class TooltipDocComponent implements OnInit {
  ...
  does = ['Explain the function of an user interactive element.',
  'Showing full version of shortened text.'];
  donts = ['If you can\'t think of any particularly useful content in a tooltip.',
