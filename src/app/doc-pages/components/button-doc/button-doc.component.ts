...
example3 = `<div>
  ...
  <button class="e-btn e-btn--tertiary e-btn--lg e-m-16" disabled >
    <span class="e-btn__icon"><i class="e-icon-download e-icon-disabled"></i></span>
...
`;
  ...
  <div>
    <button class="e-btn e-btn--lg e-m-16" >
      <span class="e-btn__icon"><i class="e-icon-add-circle-filled e-icon-invert"></i></span>
      <span class="e-btn__title">Icon button</span>
    </button>
    <button class="e-btn e-btn--lg e-m-16" disabled >
      <span class="e-btn__icon"><i class="e-icon-add-circle-filled e-icon-disabled"></i></span>
      <span class="e-btn__title">Icon button</span>
    </button>
  </div>
  <div>
