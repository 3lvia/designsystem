...
`;
  ...
  <thead>
    <tr>
      ...
      <th scope="col" class="e-text-right">400 V (3-fase)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td class="e-text-right">150 kr/kW/mnd</td>
      <td class="e-text-right">150 kr/kW/mnd</td>
      <td class="e-text-right">122 kr/kW/mnd</td>
      <td class="e-text-right">122 kr/kW/mnd</td>
    </tr>
    <tr>
      <th scope="row">40 A</th>
      <td class="e-text-right">80 kr/kW/mnd</td>
      <td class="e-text-right">80 kr/kW/mnd</td>
      <td class="e-text-right">52 kr/kW/mnd</td>
      <td class="e-text-right">52 kr/kW/mnd</td>
    </tr>
    <tr>
      <th scope="row">50 A</th>
      <td class="e-text-right">23 kr/kW/mnd</td>
      <td class="e-text-right">23 kr/kW/mnd</td>
      <td class="e-text-right">17 kr/kW/mnd</td>
      <td class="e-text-right">17 kr/kW/mnd</td>
    </tr>
  </tbody>
</table>
