module.exports = [
  ...
  {name:'arrow_down', terms: [] }, 
  {name:'arrow_down-bold', terms: [] }, 
  ...
  {name:'arrow_right', terms: [] }, 
  {name:'arrow_right-bold', terms: [] }, 
  {name:'arrow_up', terms: [] }, 
  {name:'arrow_up-bold', terms: [] }, 
  ...
  {name:'delete', terms: ['bin', 'trash'] }, 
  {name:'delete-color', terms: ['bin', 'trash'] }, 
  ...
  {name:'loading', terms: [] }, 
  {name:'lock', terms: [] }, 
  {name:'mail', terms: ['e-mail','post','letter'] }, 
  {name:'mail_error-color', terms: ['e-mail','post','letter','fail','wrong'] }, 
  {name:'mail_monitor-color', terms: ['observe'] }, 
  {name:'mail_send-color', terms: ['e-mail','post','letter'] }, 
  ...
  {name:'warning-circle-filled-color', terms: ['!', 'danger','alert','caution','exclamation'] }, 
