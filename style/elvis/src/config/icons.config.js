module.exports = [
  ...
  { name: 'notification-bold', terms: ['alert'] },
  ...
  { name: 'pdf_document', terms: [] },
  { name: 'pie_chart', terms: [] },
  { name: 'pin', terms: [] },
  { name: 'pin-color', terms: [] },
  { name: 'play_circle-color', terms: ['start'] },
  { name: 'play_circle-filled-color', terms: ['start'] },
